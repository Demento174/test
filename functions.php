...
function twentytwenty_register_scripts() {
    ...
    wp_enqueue_script( 'build-js', get_template_directory_uri() . '/assets/build/bundle.js', array(), $theme_version, true );
    wp_script_add_data( 'twentytwenty-js', 'async', true );
    wp_localize_script( 'build-js', 'myajax',
        array(
...
require_once (get_template_directory().'/Modules/LikeAndDislike/init.php');

\Modules\LikeAndDislike\Index::init();
